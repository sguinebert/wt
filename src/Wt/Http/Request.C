...
namespace Wt
{
  namespace Http
  {
    ...
    // UploadedFile is now provided by Wt::http::UploadedFile (cuehttp/uploaded_file.hpp)
...
#ifndef WT_TARGET_JAVA
    void Request::parseFormUrlEncoded(const std::string &s, ParameterMap &parameters)
    {
