...
awaitable<void> Sqlite3::startTransaction()
{
  co_await executeSql("begin transaction");
}

awaitable<void> Sqlite3::commitTransaction()
{
  co_await executeSql("commit transaction");
}

awaitable<void> Sqlite3::rollbackTransaction()
{
  co_await executeSql("rollback transaction");
}
}
}
}
