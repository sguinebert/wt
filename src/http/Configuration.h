...
public:
  ...
  const std::vector<std::string>& staticPaths() const { return staticPaths_; }
  ...
  const std::string& sslCertificateChainFile() const { return sslCertificateChainFile_; }
  ...
  const std::string& sslClientVerification() const { return sslClientVerification_; }
  ...
  typedef std::function<std::string (std::size_t max_length, int purpose)> SslPasswordCallback;
